...
<body>
        ...
        <div class="calendario">
            <div class="encabezado">
                <div class="materia">
                    ...
                    <label for="" id="txtGrupo"><?php echo $codigoGrupo; ?> | <?php echo $horaInicio; ?> -
                        <?php echo $horaFin; ?></label>
                ...
                <div class="botonesCalendario">
                    <div class="SubBtnCalnd">
                        ...
                        <a id="registroLink" href="registroManual.php?id=<?= urlencode($idClase) ?>&fecha="
                            ...
                            <?php if (isset($alumnos) && is_array($alumnos) && count($alumnos) > 0): ?>
                                <?php foreach ($alumnos as $alumno): ?>
                                    <tr>
                                        ...
                                        <td><a href="eliminarAlumno.php?id=<?= urlencode($idClase) ?>&noControl=<?= urlencode($alumno->noControl) ?>"
    ...
    <script>
        const idClase = <?= json_encode($idClase); ?>;
    </script>
