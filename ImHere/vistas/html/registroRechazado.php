...
<head>
    ...
    <link rel="stylesheet" href="../css/registroRechazado.css">
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="name-help">
                ...
                <form class="d-flex" role="search">
                    <a href="registroManual.html" class="btn btn-sm btn-outline-light" type="button"
    ...
    <div class="form">
        ...
        <div class="centro">
            ...
            <div class="tarj">
                <label for="txtTarjeta">Vuelve a intentarlo</label>
            </div>
